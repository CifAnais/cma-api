...
// BKCategories
#define COCOAPODS_POD_AVAILABLE_BKCategories
#define COCOAPODS_VERSION_MAJOR_BKCategories 0
#define COCOAPODS_VERSION_MINOR_BKCategories 1
#define COCOAPODS_VERSION_PATCH_BKCategories 0
